<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetalleSolicitud.aspx.cs" Inherits="webFacturas.Admin.DetalleSolicitud" %>
...
<head>
    ...
    <title>Administración | Destalle Solicitud</title>
...
<body class="theme-cyan">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../index.html"><strong>FULANOS S.A.</strong> - SISTEMA DE REEMBOLSO DE FACTURAS</a>
            </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>Atención a Solicitudes
                    <small>Revisar la solicitud y aprobar o rechazar dicha solicitud de reembolso.</small>
                </h2>
            </div>
            <!-- Basic Validation -->
                            ...
                            <form id="frmAgregarUsuario" autocomplete="off" runat="server">
                                <div class="row clearfix">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <asp:TextBox ID="txtNombreProyecto" CssClass="form-control" Text="Proyeto patito" runat="server" disabled="true"></asp:TextBox>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="form-line disabled">
                                                <asp:TextBox ID="txtFecha" CssClass="form-control" Text="22/05/2020" runat="server" disabled="true"></asp:TextBox>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="form-line disabled">
                                                <asp:TextBox ID="txtEstado" CssClass="form-control" Text="22/05/2020" runat="server" disabled="true"></asp:TextBox>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <asp:TextBox ID="txtNombreEmpleado" CssClass="form-control" Text="Edy Estuardo Pérez Garcia
                                                "
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="form-line disabled">
                                                <asp:TextBox ID="txtCodEmpleado" CssClass="form-control" Text="1013" runat="server" disabled="true"></asp:TextBox>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <asp:TextBox ID="txtConcepto" CssClass="form-control" Text="Edy Estuardo Pérez Garcia
                                                "
                                                    runat="server" disabled="true"></asp:TextBox>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="form-line disabled">
                                                <asp:TextBox ID="txtNoFactura" CssClass="form-control" Text="1013" runat="server" disabled="true"></asp:TextBox>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <div class="form-line disabled">
                                                <asp:TextBox ID="txtCantidad" CssClass="form-control" Text="1013" runat="server" disabled="true"></asp:TextBox>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="form-line disabled">
                                                <asp:TextBox ID="txtMonto" CssClass="form-control" Text="1013" runat="server" disabled="true"></asp:TextBox>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            <div class="form-line disabled">
                                                <asp:TextBox ID="txtLugarEmitido" CssClass="form-control" Text="1013" runat="server" disabled="true"></asp:TextBox>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <asp:TextBox ID="txtDescripcion" CssClass="form-control" Text="Edy Estuardo Pérez Garcia" runat="server" disabled="true" TextMode="MultiLine" Rows="5"></asp:TextBox>
                                                <label class="form-label">Descripción</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <asp:Button ID="btnEliminar" CssClass="btn btn-lg btn-danger waves-effect" runat="server" Text="Rechazar" OnClick="btnEliminar_Click" />
                                <asp:Button ID="btnRegistrar" CssClass="btn btn-lg btn-success waves-effect" runat="server" Text="Aprobar" OnClick="btnRegistrar_Click" />
    ...
    <script>
        function validar() {
            var si = confirm("¿Desea eliminar este usuario?");
    ...
    <!-- Select -->
    <script src="../Contents/plugins/bootstrap-select/js/bootstrap-select.min.js"></script>
