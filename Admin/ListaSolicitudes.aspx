<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListaSolicitudes.aspx.cs" Inherits="webFacturas.Admin.ListaSolicitudes" %>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>Administración Solicitudes</h2>
            </div>
            <!-- Basic Table -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Solicitudes
                                <small>Clic en atender para revisar solicitud</small>
                            </h2>
                        </div>
                            ...
                            <form id="frmListaSolicitudes" runat="server">
                                <asp:GridView AutoGenerateColumns="False" CssClass="table" ID="grdViewSolicitudes" runat="server" BorderStyle="None" GridLines="None" OnRowCommand="grdViewSolicitudes_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="CodEmpleado" HeaderText="Cod. Empleado" />
                                        ...
                                        <asp:ButtonField CommandName="Atender" Text="Atender" ButtonType="Button">
